...
export default function Home() {
  return (
    <>
      ...
      >
        flow is a free web application to give you full control over flowers
        inside your office whether you are indie startup or professional
        corporate. Its crafted with Next.js, TailwindCSS & Prisma.
      </SectionTitle>
      ...
      <SectionTitle pretitle="FAQ" title="Frequently Asked Questions">
        Before you send us a message take a look at a frequent messages that our
        helpline have to deal with.
      </SectionTitle>
      <Faq />
      <Cta />
      <Footer />
